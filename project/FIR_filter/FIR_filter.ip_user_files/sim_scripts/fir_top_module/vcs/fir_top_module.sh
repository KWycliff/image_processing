...
design_libs=(xbip_utils_v3_0_10 axi_utils_v2_0_6 xbip_pipe_v3_0_6 xbip_bram18k_v3_0_6 mult_gen_v12_0_18 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_6 xbip_dsp48_multadd_v3_0_6 dds_compiler_v6_0_22 xil_defaultlib sim_clk_gen_v1_0_3 c_reg_fd_v12_0_6 xbip_addsub_v3_0_6 c_addsub_v12_0_15)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fir_top_module xil_defaultlib.glbl -o fir_top_module_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fir_top_module_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fir_top_module_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fir_top_module_simv.daidir vcs_lib c.obj)
