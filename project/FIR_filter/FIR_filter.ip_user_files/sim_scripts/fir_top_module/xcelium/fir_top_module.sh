...
#
# Script generated by Vivado on Tue Aug 11 11:31:24 +0300 2026
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : fir_top_module.sh
...
#
# Usage        : fir_top_module.sh
#                fir_top_module.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fir_top_module.sh [-reset_run]
#                fir_top_module.sh [-reset_log]
#                fir_top_module.sh [-help]
#
...
#                script (type 'fir_top_module.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_10 -libname axi_utils_v2_0_6 -libname xbip_pipe_v3_0_6 -libname xbip_bram18k_v3_0_6 -libname mult_gen_v12_0_18 -libname xbip_dsp48_wrapper_v3_0_4 -libname xbip_dsp48_addsub_v3_0_6 -libname xbip_dsp48_multadd_v3_0_6 -libname dds_compiler_v6_0_22 -libname xil_defaultlib -libname sim_clk_gen_v1_0_3 -libname c_reg_fd_v12_0_6 -libname xbip_addsub_v3_0_6 -libname c_addsub_v12_0_15 -libname fir_compiler_v7_2_19 -libname xlconstant_v1_1_7 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_10 axi_utils_v2_0_6 xbip_pipe_v3_0_6 xbip_bram18k_v3_0_6 mult_gen_v12_0_18 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_6 xbip_dsp48_multadd_v3_0_6 dds_compiler_v6_0_22 xil_defaultlib sim_clk_gen_v1_0_3 c_reg_fd_v12_0_6 xbip_addsub_v3_0_6 c_addsub_v12_0_15 fir_compiler_v7_2_19 xlconstant_v1_1_7)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "fir_top_module.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fir_top_module.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fir_top_module xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fir_top_module -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fir_top_module_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fir_top_module.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fir_top_module.sh [-help]\n\
Usage: fir_top_module.sh [-step]\n\
Usage: fir_top_module.sh [-lib_map_path]\n\
Usage: fir_top_module.sh [-reset_run]\n\
Usage: fir_top_module.sh [-reset_log]\n\
Usage: fir_top_module.sh [-keep_index]\n\
Usage: fir_top_module.sh [-noclean_files]\n\n\
